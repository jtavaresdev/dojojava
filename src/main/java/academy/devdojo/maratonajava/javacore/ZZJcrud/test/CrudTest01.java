...
import academy.devdojo.maratonajava.javacore.ZZJcrud.services.AnimeServices;
import academy.devdojo.maratonajava.javacore.ZZJcrud.services.ProducerServices;
        ...
        while (true) {
            ...
            switch (op) {
                case 1 -> {
                    ...
                    ProducerServices.buildMenu(op);
                }
                case 2 -> {
                    animeMenu();
                    op = Integer.parseInt(SCANNER.nextLine());
                    AnimeServices.buildMenu(op);
                }
            }
